...
public class UserRedisReflashInterceptor implements HandlerInterceptor {

    private StringRedisTemplate stringRedisTemplate;
    private ObjectMapper objectMapper;

    public UserRedisReflashInterceptor(StringRedisTemplate stringRedisTemplate, ObjectMapper objectMapper) {
